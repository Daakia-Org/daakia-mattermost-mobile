...
import com.daakia.helpers.database_extension.getDatabaseForServer
import com.daakia.helpers.database_extension.saveToDatabase
import com.daakia.helpers.push_notification.addToDefaultCategoryIfNeeded
import com.daakia.helpers.push_notification.fetchMyChannel
import com.daakia.helpers.push_notification.fetchMyTeamCategories
import com.daakia.helpers.push_notification.fetchNeededUsers
import com.daakia.helpers.push_notification.fetchPosts
import com.daakia.helpers.push_notification.fetchTeamIfNeeded
import com.daakia.helpers.push_notification.fetchThread
        ...
        private fun getThreadList(notificationThread: ReadableMap?, threads: ReadableArray?): ArrayList<ReadableMap>? {
            threads?.let {
                ...
                for(i in 0 until it.size()) {
                    val thread = it.getMap(i) ?: continue
